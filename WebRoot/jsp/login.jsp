...
<script type="text/javascript" src="<%=basePath%>js/jquery.sgallery.js"></script>
...
<form name="loginform" action="Login" method="post">
       <INPUT name="userName" class="ipt" type="text" placeholder="请输入用户名或邮箱" value="${userName }"> 
    </P>
    <br>
<P style="position: relative;"><SPAN class="p_logo"></SPAN>         
<INPUT class="ipt" id="password" name="passWord" type="password" placeholder="请输入密码" value="${passWord}">   
  </P>
  <P><font color="red">${error}</font></P>
<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
<P style="margin: 0px 35px 20px 45px;"><SPAN style="float: left;"><A style="color: rgb(204, 204, 204);" 
href="#">忘记密码?</A></SPAN> 
           <SPAN style="float: right;"><A style="color: rgb(0, 142, 173); margin-right: 10px;" 
href="Register">注册</A>  
...
href="javascript:document.loginform.submit();">登录</A> 
</form>
     </SPAN>    
  </P>
  </DIV>
