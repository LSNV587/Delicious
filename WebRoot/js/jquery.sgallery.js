...
$(function(){
	$('.nav-li').hover(function(){
		$(this).addClass('hover');
		$(this).children('.nav-child').slideDown('normal');
	},
	function(){
		$(this).removeClass('hover');
		$(this).children('.nav-child').slideUp('normal');
	});
});
...
jQuery.fn.LoadImage=function(scaling,width,height,loadpic){
    if(loadpic==null)loadpic="../images/msg_img/loading.gif"/*tpa=http://60th.bupt.edu.cn/images/msg_img/loading.gif*/;
...
//滑动
$(function(){
	new slide("#main-slide","cur",570,400,1);//焦点图
...
for(i=0;i<tli.length;i++){
   tli[i].className=i==n?"hover lf":"lf";
